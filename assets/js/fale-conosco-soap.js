...
// inicio - limpar campos uasg e cnpj
document.addEventListener('DOMContentLoaded', function() {
    var radio1 = document.getElementById('toggle2');
    var radio2 = document.getElementById('toggle1');
    var field_number_uasg = document.getElementById('number_uasg');
    var field_cnpj = document.getElementById('cnpj');

    radio1.addEventListener('click', function() {
        field_cnpj.value = ''; 
		console.log('cnpj limpo');
    });

    radio2.addEventListener('click', function() {
        field_number_uasg.value = ''; 
				console.log('cnpj uasg limpo');
    });
});
// fim - limpar campos uasg e cnpj
	// inicio -  validacao do arquivo maior que 2 megas 
	...
	// fim -  validacao do arquivo maior que 2 megas 
	// inicio - modal exemplo
		const modalCExemplo = document.getElementById("modalExemplo");
		const btnCExemplo = document.getElementById("callExemplo");
		const spanCExemplo = document.getElementsByClassName("closeCExemplo")[0];

		btnCExemplo.onclick = function() {
			modalCExemplo.style.display = "block";
		}

		spanCExemplo.onclick = function() {
			modalCExemplo.style.display = "none";
		}

		window.onclick = function(event) {
			if (event.target == modalCExemplo) {
				modalCExemplo.style.display = "none";
			}
		}
	// fim - modal exemplo
