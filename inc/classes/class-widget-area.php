...
if ( ! class_exists( 'Prodesp_Widget_Area' ) ) {

	class Prodesp_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'Prodesp-theme/widget-area/render', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'Prodesp-theme/widget_area/rendering_current', $area_id );
			...
			$classes = apply_filters( 'Prodesp-theme/widget_area/classes', $classes, $area_id );
	...
	function Prodesp_widget_area() {
		return Prodesp_Widget_Area::get_instance();
	}
