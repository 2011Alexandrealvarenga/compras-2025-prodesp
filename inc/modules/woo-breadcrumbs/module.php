...
if ( ! class_exists( 'Prodesp_Woo_Breadcrumbs_Module' ) ) {

	/**
	 * Define Prodesp_Woo_Breadcrumbs_Module class
	 */
	class Prodesp_Woo_Breadcrumbs_Module extends Prodesp_Module_Base {
		...
		public function get_wc_breadcrumbs( $is_custom_breadcrumbs, $args ) {
			...
			$wc_breadcrumbs = new Prodesp_WC_Breadcrumbs( $args );
