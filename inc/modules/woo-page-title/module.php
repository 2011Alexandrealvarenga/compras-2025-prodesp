...
if ( ! class_exists( 'Prodesp_Woo_Page_Title_Module' ) ) {

	/**
	 * Define Prodesp_Woo_Page_Title_Module class
	 */
	class Prodesp_Woo_Page_Title_Module extends Prodesp_Module_Base {
